"""
Django settings for fifth_task project.
...
SECRET_KEY = 'django-insecure-*r_ianw2g#9s)+eft+h1)5r=2vlya6sl98b!fr*=79%j-no785'
...
WSGI_APPLICATION = 'fifth_task.wsgi.application'
